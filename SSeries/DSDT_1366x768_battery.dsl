 ...
 * 
 * Disassembly of DSDT_1366x768.aml, Fri Mar 30 12:28:43 2012
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000084B5 (33973)
...
DefinitionBlock ("DSDT_1366x768_battery.aml", "DSDT", 1, "Sony", "VAIO", 0x20111116)
{
                ...
                Device (H_EC)
                {
                    ...
                    Device (BAT1)
                    {
                        ...
                        Method (_BIF, 0, NotSerialized)
                        {
                            ...
                            Store (Multiply (B1B2 (B1DC, B0DC), 0x0A), Index (BPKG, One))
                            Store (Multiply (B1B2 (B1FC, B0FC), 0x0A), Index (BPKG, 0x02))
                            Store (B1B2 (B1DV, B0DV), Index (BPKG, 0x04))
                            If (B1B2 (B1FC, B0FC))
                            {
                                Store (B1B2 (B1FC, B0FC), Index (BPKG, 0x05))
                                Store (One, Index (BPKG, 0x06))
                                Store (Divide (Multiply (B1B2 (B1DC, B0DC), 0x0A), 0x01F4), Index (BPKG, 0x07))
                                Store (Divide (Multiply (B1B2 (B1DC, B0DC), 0x0A), 0x01F4), Index (BPKG, 0x08))
                            }
                        ...
                        Method (_BST, 0, NotSerialized)
                        {
                            ...
                            Store (Multiply (Local0, B1B2 (B1FV, B0FV)), Local0)
                            Store (Divide (Local0, 0x03E8, ), Local0)
                            Store (Local0, Index (PKG1, One))
                            Store (Multiply (B1B2 (B1RC, B0RC), 0x0A), Index (PKG1, 0x02))
                            Store (B1B2 (B1FV, B0FV), Index (PKG1, 0x03))
                            Return (PKG1)
                        }
